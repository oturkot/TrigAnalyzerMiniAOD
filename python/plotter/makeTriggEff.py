...
# LW draw also the ref distr.
###            hCol2 = kRed
###            hRef.SetFillColorAlpha(hCol2,hAlpha)
###            hRef.SetLineColorAlpha(hCol,hAlpha)
###            hRef.Scale(sf)
###            hRef.Draw("samehist")
###            leg.AddEntry(hRef,varToLabel(var)+' distribution Ref.','f')
...
#    basecuts += 'nJets30Clean >=3 &&'
    ...
    if 'SingleEl' in fileName:
        ...
        if 'golden205pb' in fileName:
            ...
            lumi = 666
#        elif 'Run2016BCDEFGH' in fileName:
#            lumi = 35.9
...
#        testTrig = ['Ele50PFJet165']
#        testTrig = ['IsoEle27T']
#        testTrig = ['Ele105']
#        testTrig = ['Ele115']
#        testTrig = ['EleHT400']
#        testTrig = ['EleHT350']
#        testTrig = ['Ele50PFJet165||IsoEle27T||Ele105||Ele115||EleHT350||EleHT400']
##        testTrig = ['EleOR']

#        testTrig = ['MET100MHT100']
#        testTrig = ['MET110MHT110']
#        testTrig = ['MET120MHT120']
#        testTrig = ['MET100MHT100||MET110MHT110||MET120MHT120']
##        testTrig = ['MetOR']
...
#        cuts = basecuts + 'nEl == 1 && Lep_pt > 25'
        cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && LT > 250'
...
##        makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
        ...
        varList = ['HT']
        cuts = basecuts + 'nMu == 1 && Lep_pt > 25 && LT > 250'
...
##        varList = ['Lep_pt']
        varList = ['HT']
#        varList = ['LT','Jet1_pt'] #LTNoHF
#        varList = ['Jet1_pt']

#        cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && LT > 250'
        cuts = basecuts + 'nEl == 1 && Lep_pt > 25'
#        cuts = basecuts + 'nEl == 1 && HT > 500 && LT > 250'
#        cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && HT > 500'
#        cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && nJets30Clean >= 5 && Jet2_pt > 80 && HT > 500'
#        cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && HT > 500'
## Unknown : RA2_muJetFilter == 1, Flag_fastSimCorridorJetCleaning
#        cuts = basecuts + 'nEl == 1 && Lep_pt > 25 && HT > 500 && nVeto == 0 && METfilters == 1 && !iso_Veto && nJets30Clean >= 5 && Jet2_pt > 80 && !HLT_PFJet450'
##        testTrig = ['EleOR||MetOR']
        testTrig = ['Ele105||Ele115||Ele50PFJet165||EleHT400||EleHT350||MetOR']
##        testTrig = ['PFJet450']
        makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)

##        cuts = basecuts + 'nMu == 1 && HT > 500 && LT > 250'
#        cuts = basecuts + 'nMu == 1 && Lep_pt > 25 && HT > 500'
##        testTrig = ['MuOR||MetOR']
##        makeEffPlots(tree, lumi, maxEntries, doFit, varList, refTrig, testTrig, cuts)
